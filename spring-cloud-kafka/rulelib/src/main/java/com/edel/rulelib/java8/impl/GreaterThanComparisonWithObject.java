...
@NoArgsConstructor
@ToString
public class GreaterThanComparisonWithObject implements MatchRuleWithObject {
    ...
    public ExecutionEvent matches(Object inputObject) {
        ...
        try{
            ...
            returnableExecutionEvent.setOutcome(ExpressionHelper.compareObjectsForGreaterThan(leftFieldObject, rightFieldObject));
            returnableExecutionEvent.setRuleString(left+" GREATER THAN "+right+" : "+leftFieldObject+" GREATER THAN "+rightFieldObject);
