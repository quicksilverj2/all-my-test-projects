...
@NoArgsConstructor
@ToString
public class GreaterThanOrEqualsComparisonWithObject implements MatchRuleWithObject {
    ...
    public ExecutionEvent matches(Object inputObject) {
        ...
        try{
            ...
            returnableExecutionEvent.setOutcome(ExpressionHelper.compareObjectsForGreaterThanOrEquals(leftFieldObject, rightFieldObject));
            returnableExecutionEvent.setRuleString(left+" GREATER THAN OR EQUALS "+right+" : "+leftFieldObject+" GREATER THAN OR EQUALS "+rightFieldObject);
