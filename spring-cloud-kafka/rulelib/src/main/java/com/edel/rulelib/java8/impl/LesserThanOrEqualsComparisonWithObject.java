...
@NoArgsConstructor
@ToString
public class LesserThanOrEqualsComparisonWithObject implements MatchRuleWithObject {
    ...
    public ExecutionEvent matches(Object inputObject) {
        ...
        try{
            ...
            returnableExecutionEvent.setOutcome(ExpressionHelper.compareObjectsForLessThanOrEquals(leftFieldObject, rightFieldObject));
            returnableExecutionEvent.setRuleString(left+" LESS THAN OR EQUALS "+right+" : "+leftFieldObject+" LESS THAN OR EQUALS "+rightFieldObject);
