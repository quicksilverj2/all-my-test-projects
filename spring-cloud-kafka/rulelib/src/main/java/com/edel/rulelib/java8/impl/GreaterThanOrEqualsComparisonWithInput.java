...
@NoArgsConstructor
@ToString
public class GreaterThanOrEqualsComparisonWithInput implements MatchRuleWithInput {
    ...
    public boolean matches(Object input) {
        return ExpressionHelper.compareObjectsForGreaterThanOrEquals(left, input);
    }
